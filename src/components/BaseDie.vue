...
<template>
  <span
    ...
    class="die"
    :class="{
      highest: die.lowest === false
    }"
    ><span class="number">{{ die.result }}</span></span
  >
  <span v-else-if="die.cancelled" class="die cancelled"><span class="number">x</span></span>
  <span
